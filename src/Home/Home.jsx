...
import SectionNewsDashboard from "../Components/SectionNewsDashboard";
        ...
        <div className="w-full h-auto pl-24">
          ...
          <div className="w-full h-auto px-20 pt-10">
            <section className="w-auto h-auto">
              ...
              <span className="text-gray-400">Saudações Novamente!</span>
            </section>
            ...
            <div className="w-full flex justify-between gap-6">
              ...
              <div className="w-auto grow flex flex-col items-start gap-0">
                <div className="w-full flex justify-between py-3 items-center h-auto">
                  <a href="" className="text-2xl">Posts Recentes</a>
                ...
                {noticias.map((item, index) => {
                  return (
                    <SectionNewsDashboard key={index} titulo={item.titulo} img={item.img} coments={item.coments} viwes={item.viwes}></SectionNewsDashboard>
                  );
                })}
              </div>
            </div>
